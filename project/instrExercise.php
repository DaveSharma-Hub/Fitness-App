          ...
          for($i=0;$i<count($result2->UID);$i++){
            echo "<button onclick=\"document.getElementById('".$i."').style.display='block'\">".$result2->FName[$i]." ".$result2->LName[$i]."</button>
                    ...
                    <input type='hidden' id='UID' name='exercisePlanIID' value=".$result->IID.">
                        <h1>Monday</h1>
                        Muscle Group:<input type='text' placeholder='ex: Triceps' name='exercisePlanMonday' required><br>
                        <h1>Tuesday</h1>
                        Muscle Group:<input type='text' placeholder='ex: Back'name='exercisePlanTuesday' required><br>
                        <h1>Wednsday</h1>
                        Muscle Group:<input type='text' placeholder='ex: Shoulders' name='exercisePlanWednesday' required><br>
                        <h1>Thursday</h1>
                        Muscle Group:<input type='text' placeholder='ex: Chest' name='exercisePlanThursday' required><br>
                        <h1>Friday</h1>
                        Muscle Group:<input type='text' placeholder='ex: Biceps' name='exercisePlanFriday' required><br>
                        <h1>Saturday</h1>
                        Muscle Group:<input type='text' placeholder='ex: Rest' name='exercisePlanSaturday' required><br>
                        <h1>Sunday</h1>
                        Muscle Group:<input type='text' placeholder='ex: Legs' name='exercisePlanSunday' required><br>
