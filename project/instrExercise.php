            ...
            for($i=0;$i<3;$i++){
                echo "<button onclick=\"document.getElementById('id01').style.display='block'\">User</button>
                        ...
                        <form class='modal-content animate'>
                            <h1>Monday</h1>
                            Muscle Group:<input type='text' placeholder='ex: Triceps' name='psw' required><br>
                            <h1>Tuesday</h1>
                            Muscle Group:<input type='text' placeholder='ex: Back'name='psw' required><br>
                            <h1>Wednsday</h1>
                            Muscle Group:<input type='text' placeholder='ex: Shoulders' name='psw' required><br>
                            <h1>Thursday</h1>
                            Muscle Group:<input type='text' placeholder='ex: Chest' name='psw' required><br>
                            <h1>Friday</h1>
                            Muscle Group:<input type='text' placeholder='ex: Biceps' name='psw' required><br>
                            <h1>Saturday</h1>
                            Muscle Group:<input type='text' placeholder='ex: Rest' name='psw' required><br>
                            <h1>Sunday</h1>
                            Muscle Group:<input type='text' placeholder='ex: Legs' name='psw' required><br>
