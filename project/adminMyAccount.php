<?php
    ...
    // }
    session_start();
    $id = $_SESSION['adid'];//1 ;// FROM THE SESSION 
  ...
  <form class="modal-content animate" id="foo" action="" method="POST"> 
    ...
    <div class="modal-container">
     <input type="hidden" id="custId" name="custId" value=<?php echo $id?>> 
      First Name<input type="text" placeholder=<?php echo $result->fname?> name="myAccountAdminFname" required><br>
      Last Name<input type="text" placeholder=<?php echo $result->lname?> name="myAccountAdminLname" required><br>
      Username<input type="text" placeholder=<?php echo $result->username?> name="myAccountAdminUsername" required><br>
      Email<input type="text" placeholder=<?php echo $result->email?> name="myAccountAdminEmail" required><br>
      Password<input type="password" placeholder="********" name="myAccountAdminPsw" required><br>
      Age<input type="text" placeholder=<?php echo $result->age?> name="myAccountAdminAge" required><br>
